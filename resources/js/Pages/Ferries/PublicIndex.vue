...
<template>
    ...
    <GuestLayout :fullWidth="true">
        ...
        <div class="py-12 bg-cream-50 min-h-screen">
            <div
                class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16 animate-fade-in"
            >
                <div
                    class="inline-block px-4 py-1.5 mb-6 text-[10px] font-black tracking-widest text-blue-900 uppercase rounded-full bg-blue-100 shadow-sm border border-blue-200"
                >
                    Premium Marine Standards
                </div>
                <h1
                    class="text-5xl font-black text-blue-900 mb-6 tracking-tight sm:text-6xl"
                >
                    Our Marine Fleet
                </h1>
                <p
                    class="text-xl text-blue-800/60 max-w-2xl mx-auto font-medium leading-relaxed"
                >
                    Explore our collection of modern, safe, and comfortable
                    vessels serving the Malaysian coastline.
                </p>
            </div>
                    ...
                    >
                        <div class="relative h-72 bg-blue-50 overflow-hidden">
                            ...
                            >
                                ...
                                <p
                                    class="text-blue-100/80 text-sm font-bold uppercase tracking-wider"
                                >
                                    {{ ferry.operator }}
                                </p>
                            </div>
                        ...
                        <div class="p-8 flex-1 flex flex-col bg-white">
                            ...
                            <div class="mb-8">
                                <div class="flex flex-wrap gap-2">
                                    <span
                                        ...
                                        :key="amenity"
                                        class="px-3 py-1.5 bg-blue-50 text-blue-700 text-[10px] font-black uppercase rounded-lg border border-blue-100"
                                    >
                                        {{ amenity }}
                                    </span>
                                    <span
                                        ...
                                        "
                                        class="text-xs text-blue-300 italic font-medium"
                            ...
                            <div
                                class="mt-auto flex items-center justify-between pt-6 border-t border-blue-50"
                            >
                                <div>
                                    <p
                                ...
                                <Link
                                    :href="
                                        route('ferries.public_show', ferry.id)
                                    "
                                    class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-2xl font-black text-sm transition-all shadow-lg shadow-blue-100 transform active:scale-95"
                                >
                                    VIEW VESSEL
                                </Link>
                            </div>
